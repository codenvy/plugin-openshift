 ...
 */
@Singleton
public class ConfigureConfigureApplicationViewImpl extends Window implements ConfigureApplicationView {

    interface ConfigureApplicationViewImplUiBinder extends UiBinder<Widget, ConfigureConfigureApplicationViewImpl> {
    }

    private static ConfigureApplicationViewImplUiBinder uiBinder = GWT.create(ConfigureApplicationViewImplUiBinder.class);
    ...
    private final Category.CategoryEventDelegate<ConfigPresenter> configDelegate =
            new Category.CategoryEventDelegate<ConfigPresenter>() {
                @Override
                public void onListItemClicked(com.google.gwt.dom.client.Element listItemBase, ConfigPresenter itemData) {
    ...
    private final CategoryRenderer<ConfigPresenter> configViewRenderer =
            new CategoryRenderer<ConfigPresenter>() {
                @Override
                public void renderElement(com.google.gwt.dom.client.Element element, ConfigPresenter configView) {
                    element.setInnerText(configView.getTitle());
                }

                @Override
                public com.google.gwt.dom.client.SpanElement renderCategory(Category<ConfigPresenter> category) {
    ...
    @Inject
    protected ConfigureConfigureApplicationViewImpl(OpenshiftLocalizationConstant locale, OpenshiftResources openshiftResources,
        ...
        Button btnClose = createButton(locale.buttonClose(), "openshiftApplicationConfig-btnClose", new ClickHandler() {
            @Override
