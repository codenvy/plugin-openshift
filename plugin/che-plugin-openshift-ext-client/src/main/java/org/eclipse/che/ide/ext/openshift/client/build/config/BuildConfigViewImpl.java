...
public class BuildConfigViewImpl implements BuildConfigView {
  ...
  private static BuildConfigViewImplUiBinder uiBinder =
      GWT.create(BuildConfigViewImplUiBinder.class);
  ...
  @UiField TextBox sourceUrl;

  @UiField TextBox sourceReference;

  @UiField TextBox sourceContextDir;
  ...
  @UiField FlowPanel webhooksPanel;

  @UiField Label noWebhooksMessage;

  @UiField Label noBuildConfigsMessage;
