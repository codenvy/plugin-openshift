...
public class RouteConfigViewImpl implements RouteConfigView {
  ...
  private static RouteConfigViewImplUiBinder ourUiBinder =
      GWT.create(RouteConfigViewImplUiBinder.class);

  @UiField FlowPanel urlsPanel;

  @UiField Button saveRouteUrlsButton;

  @UiField Button resetRouteUrlsButton;
  ...
  public void showApplicationURLs(@NotNull List<String> urLs) {
    ...
    for (final String url : urLs) {
      ...
      buttonBuilder
          .withResourceWidget(urlInput)
          .withParentWidget(inputPanel)
          .build()
          .getStyle()
