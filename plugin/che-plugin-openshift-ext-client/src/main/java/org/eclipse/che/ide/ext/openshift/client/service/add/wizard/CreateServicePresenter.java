 ...
 */
@Singleton
public class CreateServicePresenter
    implements Wizard.UpdateDelegate, CreateServiceWizardView.ActionDelegate {
        ...
        new Wizard.CompleteCallback() {
          ...
          public void onCompleted() {
            ...
            notificationManager.notify(
                locale.createServiceFromTemplateSuccess(), SUCCESS, EMERGE_MODE);
            view.closeWizard();
          }
          ...
          public void onFailure(Throwable e) {
            ...
            notificationManager.notify(
                locale.createServiceFromTemplateFailed() + " " + message, FAIL, EMERGE_MODE);
          }
        });
  }
  ...
  public void createWizardAndShow() {
    NewServiceRequest newServiceRequest =
        dtoFactory
            .createDto(NewServiceRequest.class)
