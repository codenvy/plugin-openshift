...
public class BuildsViewImpl extends BaseView<BuildsView.ActionDelegate> implements BuildsView {
   ...
   * ****************************************************************************************************************
   *
   * <p>Project Item Represents an OpenShift application with build items as children.
   *
   * <p>****************************************************************************************************************
   */
   ...
   * ****************************************************************************************************************
   *
   * <p>Build Item Represents an OpenShift application build as project children in the project
   * tree.
   *
   * <p>****************************************************************************************************************
   */
  private class BuildItem extends FlowPanel implements MouseDownHandler {
     ...
     *
     * @param resource SVG resource
     * @param styleName style name for the icon
     */
   ...
   * ****************************************************************************************************************
   *
   * <p>Build Logger Represents a logs area for a build.
   *
   * <p>****************************************************************************************************************
   */
  private class BuildLogger extends AbsolutePanel {
    ...
    public BuildLogger(Build build) {
      ...
      header
          .getElement()
          .setInnerHTML(build.getMetadata().getNamespace() + " / " + build.getMetadata().getName());
      add(header);
    ...
    /**
     * Writes a text to the scrollable area. Scrolls the area to the bottom if logger is visible.
     *
