 ...
 */
@Singleton
public class NewApplicationPresenter extends ValidateAuthenticationPresenter
    implements NewApplicationView.ActionDelegate {
                    ...
                    .then(
                        new Operation<JsArrayMixed>() {
                          ...
                          public void apply(JsArrayMixed arg) throws OperationException {
                            ...
                            view.hide();
                            notificationManager.notify(
                                locale.deployProjectSuccess(cdProject.getName()),
                                SUCCESS,
                                EMERGE_MODE);
                            setupMixin(project);
                          }
  ...
  private void setupMixin(Project osProject) {
    ...
    attributes.put(
        OPENSHIFT_NAMESPACE_VARIABLE_NAME, newArrayList(osProject.getMetadata().getName()));
        ...
        .then(
            new Operation<org.eclipse.che.ide.api.resources.Project>() {
              ...
              public void apply(org.eclipse.che.ide.api.resources.Project project)
                ...
                notificationManager.notify(
                    locale.linkProjectWithExistingSuccess(project.getName(), osAppName),
                    SUCCESS,
                    EMERGE_MODE);
              }
            })
  ...
  private Service generateService(
      String namespace, ContainerPort port, Map<String, String> labels) {
    final ServicePort servicePort =
        newDto(ServicePort.class)
    ...
    return newDto(Service.class)
        ...
        .withMetadata(
            newDto(ObjectMeta.class)
                ...
                .withNamespace(namespace))
        .withSpec(
            newDto(ServiceSpec.class)
                .withPorts(newArrayList(servicePort))
    ...
    return newDto(Route.class)
        ...
        .withMetadata(
            newDto(ObjectMeta.class)
                ...
                .withNamespace(namespace))
        .withSpec(
            newDto(RouteSpec.class)
                .withTo(newDto(ObjectReference.class).withKind("Service").withName(osAppName)));
  }
