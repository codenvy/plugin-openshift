...
public class UnlinkProjectAction extends AbstractPerspectiveAction {
  ...
  @Inject
  public UnlinkProjectAction(
      AppContext appContext,
      NotificationManager notificationManager,
      OpenshiftLocalizationConstant locale) {
    super(
        Collections.singletonList(PROJECT_PERSPECTIVE_ID),
        locale.unlinkProjectActionTitle(),
        null,
        null,
        null);
  ...
  public void updateInPerspective(@NotNull ActionEvent event) {
    ...
    if (resource != null) {
      ...
      event
          .getPresentation()
          .setEnabled(
              project.isPresent() && project.get().getMixins().contains(OPENSHIFT_PROJECT_TYPE_ID));
    } else {
            ...
            new Operation<Project>() {
              ...
              public void apply(Project project) throws OperationException {
                notificationManager.notify(
                    locale.unlinkProjectSuccessful(project.getName()), SUCCESS, EMERGE_MODE);
              }
            })
        .catchError(
            new Operation<PromiseError>() {
              ...
              public void apply(PromiseError error) throws OperationException {
                notificationManager.notify(
                    locale.unlinkProjectFailed() + " " + error.getMessage(), FAIL, EMERGE_MODE);
              }
            });
  }
}
