...
public class NewApplicationViewImpl extends Window implements NewApplicationView {
  ...
  interface NewApplicationViewImplUiBinder
      extends UiBinder<DockLayoutPanel, NewApplicationViewImpl> {}

  private static NewApplicationViewImplUiBinder uiBinder =
      GWT.create(NewApplicationViewImplUiBinder.class);
  ...
  @UiField Label applicationNameErrorLabel;

  @UiField RadioButton createNewProject;

  @UiField RadioButton choseExistProject;

  @UiField CustomListBox images;

  @UiField Button addLabelButton;

  @UiField Button addVariableButton;

  @UiField ScrollPanel osProjectListPanel;

  @UiField Label emptyProjectsMessage;
  ...
  @UiField Label variablesErrorLabel;
  ...
  public NewApplicationViewImpl(
    ...
    deployBtn =
        createPrimaryButton(
            locale.deployProjectWindowDeploy(),
            "deployCheProject-deploy-button",
            new ClickHandler() {
              @Override
    ...
    cancelBtn =
        createButton(
            constants.cancel(),
            "deployCheProject-cancel-button",
            new ClickHandler() {
              @Override
              public void onClick(ClickEvent event) {
  ...
  private CellTable<KeyValue> createCellTable(
      CellTableResources cellTableResources,
          ...
          public void onBrowserEvent(
            ...
            if (event.getType().equals(BrowserEvents.KEYUP)) {
              ...
              if (!keyValidator.apply(newValue)) {
                parent
                    .getParentElement()
                    .addClassName(resources.css().deployApplicationTableError());
              } else {
                parent
                    .getParentElement()
                    .removeClassName(resources.css().deployApplicationTableError());
              }
    ...
    Column<KeyValue, String> nameColumn =
        new Column<KeyValue, String>(keyCell) {
          @Override
    ...
    Column<KeyValue, String> valueColumn =
        new Column<KeyValue, String>(valueCell) {
          @Override
          public String getCellStyleNames(Cell.Context context, KeyValue object) {
  ...
  public void showApplicationNameError(String labelMessage, String tooltipMessage) {
    ...
    if (!Strings.isNullOrEmpty(tooltipMessage)) {
      applicationNameErrorTooltip =
          Tooltip.create(
              (elemental.dom.Element) applicationNameErrorLabel.getElement(),
              PositionController.VerticalAlign.MIDDLE,
              PositionController.HorizontalAlign.LEFT,
              tooltipMessage);
