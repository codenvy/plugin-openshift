...
public interface NewApplicationView extends View<NewApplicationView.ActionDelegate> {
  ...
  /**
   * Show invalid OpenShift project name error message. Attach tooltip with {@code tooltipMessage},
   * if it is not null or empty, otherwise remove it.
   *
   * @param labelMessage message to display on label
   * @param tooltipMessage message to display in tooltip
   */
  ...
  /**
   * Show invalid OpenShift application name error message. Attach tooltip with {@code
   * tooltipMessage}, if it is not null or empty, otherwise remove it.
   *
   * @param labelMessage message to display on label
   * @param tooltipMessage message to display in tooltip
   */
  ...
  /**
   * Show invalid OpenShift label name error message. Attach tooltip with {@code tooltipMessage}, if
   * it is not null or empty, otherwise remove it.
   *
   * @param labelMessage message to display on label
   * @param tooltipMessage message to display in tooltip
   */
