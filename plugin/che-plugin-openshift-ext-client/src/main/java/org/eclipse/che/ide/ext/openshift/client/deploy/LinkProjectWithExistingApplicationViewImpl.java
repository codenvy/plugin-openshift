 ...
 */
public class LinkProjectWithExistingApplicationViewImpl extends Window
    implements LinkProjectWithExistingApplicationView {

  interface LinkProjectWithExistingApplicationViewUiBinder
      extends UiBinder<DockLayoutPanel, LinkProjectWithExistingApplicationViewImpl> {}
  ...
  @UiField TextBox buildConfigGitUrl;

  @UiField CustomListBox remoteUrls;

  @UiField TextBox remoteUrl;

  @UiField Label replaceWarningLabel;
  ...
  @Inject
  public LinkProjectWithExistingApplicationViewImpl(
      OpenshiftLocalizationConstant locale,
    ...
    linkButton =
        createPrimaryButton(
            locale.linkProjectWithExistingApplicationLinkButton(),
            "linkProjectWithExistingApplication-link-button",
            new ClickHandler() {
              @Override
    ...
    cancelButton =
        createButton(
            constants.cancel(),
            "linkProjectWithExistingApplication-cancel-button",
            new ClickHandler() {
              @Override
              public void onClick(ClickEvent event) {
