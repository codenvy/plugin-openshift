...
public class ConfigureProjectViewImpl implements ConfigureProjectView {
  ...
  private static ConfigureProjectViewImplUiBinder uiBinder =
      GWT.create(ConfigureProjectViewImplUiBinder.class);

  interface ConfigureProjectViewImplUiBinder
      extends UiBinder<DockPanel, ConfigureProjectViewImpl> {}

  @UiField Label osProjectNameErrorLabel;

  @UiField Label cheProjectNameErrorLabel;

  @UiField TextBox osProjectNameInput;

  @UiField TextBox osProjectDisplayNameInput;

  @UiField TextArea osProjectDescriptionInput;

  @UiField RadioButton osNewProjectButton;

  @UiField RadioButton osExistProjectButton;

  @UiField TextBox cheProjectNameInput;

  @UiField TextArea cheProjectDescriptionInput;

  @UiField ScrollPanel osExistProjectListPanel;
  ...
  @Inject
  public ConfigureProjectViewImpl(
      Resources resources, final OpenshiftResources openshiftResources) {
  ...
  public void showOsProjectNameError(@NotNull String labelMessage, String tooltipMessage) {
    ...
    if (!Strings.isNullOrEmpty(tooltipMessage)) {
      osProjectNameErrorTooltip =
          Tooltip.create(
              (elemental.dom.Element) osProjectNameErrorLabel.getElement(),
  ...
  public void showCheProjectNameError(@NotNull String labelMessage, String tooltipMessage) {
    ...
    if (!Strings.isNullOrEmpty(tooltipMessage)) {
      cheProjectNameErrorTooltip =
          Tooltip.create(
              (elemental.dom.Element) cheProjectNameErrorLabel.getElement(),
              PositionController.VerticalAlign.MIDDLE,
              PositionController.HorizontalAlign.LEFT,
              tooltipMessage);
