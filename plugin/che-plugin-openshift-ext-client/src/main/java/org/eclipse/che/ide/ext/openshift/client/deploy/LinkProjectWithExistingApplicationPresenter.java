...
public class LinkProjectWithExistingApplicationPresenter extends ValidateAuthenticationPresenter
    ...
    private void markAsOpenshiftProject(String namespace, final String application) {
        ...
        updateConfig.getAttributes().put(OPENSHIFT_APPLICATION_VARIABLE_NAME, singletonList(application));
    ...
    public void onBuildConfigSelected(BuildConfig buildConfig) {
        ...
        if (buildConfig != null) {
            ...
            view.setReplaceWarningMessage(locale.linkProjectWithExistingReplaceWarning(buildConfig.getMetadata().getName(),
                                                                                       cdProject.getName()));
        }
