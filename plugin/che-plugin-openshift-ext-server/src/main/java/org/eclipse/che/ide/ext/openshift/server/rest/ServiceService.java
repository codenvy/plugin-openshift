...
@Path("/openshift/namespace/{namespace}/service")
public class ServiceService {
  ...
  public Service createService(@PathParam("namespace") String namespace, Service service)
    ...
    if (!ResourceKind.SERVICE.equals(service.getKind())) {
      throw new BadRequestException(
          service.getKind() + " cannot be handled as a " + ResourceKind.SERVICE);
    }
  ...
  public List<Service> getServices(
    ...
    List<IService> services =
        clientFactory.getOpenshiftClient().list(ResourceKind.SERVICE, namespace, labels);
    return services
        .stream()
  ...
  public Service getService(
      @PathParam("namespace") String namespace, @PathParam("service") String service)
      throws UnauthorizedException, ServerException {

    return toDto(
        Service.class,
        clientFactory.getOpenshiftClient().get(ResourceKind.SERVICE, service, namespace));
  }
