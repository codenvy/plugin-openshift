...
public class SelectTemplateViewImpl implements SelectTemplateView {
  ...
  private static SelectTemplateViewImplUiBinder uiBinder =
      GWT.create(SelectTemplateViewImplUiBinder.class);
            ...
            new SimpleList.ListItemRenderer<Template>() {
              ...
              public void render(Element element, Template template) {
                ...
                if (!hasValidBuildConfig(template)) {
                  title
                      .getStyle()
                      .setColor(org.eclipse.che.ide.api.theme.Style.theme.getErrorColor());
                }
  ...
  /**
   * Determines whether template has properly set build configuration and contains Git URL to
   * sources.
   *
   * @param template template to check
   * @return {@code true} if template has build configuration and points to sources, otherwise
   *     returns {@code false}
   */
      ...
      for (Object o : template.getObjects()) {
        ...
        if (kind.equals("BuildConfig")) {
          BuildConfig buildConfig =
              dtoFactory.createDtoFromJson(object.toString(), BuildConfig.class);
