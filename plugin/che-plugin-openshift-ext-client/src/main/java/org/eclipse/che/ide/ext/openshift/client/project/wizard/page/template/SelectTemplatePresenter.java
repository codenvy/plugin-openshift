 ...
 */
@Singleton
public class SelectTemplatePresenter extends AbstractWizardPage<NewApplicationRequest>
  ...
  private Predicate<Parameter> GIT_URI =
  ...
  public SelectTemplatePresenter(
      SelectTemplateView view, OpenshiftServiceClient openshiftClient, DtoFactory dtoFactory) {
    this.view = view;
  ...
  public void init(NewApplicationRequest dataObject) {
    ...
    openshiftClient
        .getTemplates(DEF_NAMESPACE)
        .then(
            new Operation<List<Template>>() {
              @Override
