...
public class ReplicationControllerService {
  ...
  public List<ReplicationController> getReplicationControllers(
    ...
    List<IReplicationController> controllers =
        clientFactory
            .getOpenshiftClient()
            .list(ResourceKind.REPLICATION_CONTROLLER, namespace, labels);
    return controllers
        .stream()
  ...
  public ReplicationController getReplicationController(
    ...
    return toDto(
        ...
        clientFactory
            .getOpenshiftClient()
            .get(ResourceKind.REPLICATION_CONTROLLER, controller, namespace));
  }
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public ReplicationController updateReplicationController(
      @PathParam("namespace") String namespace,
      @PathParam("replicationController") String controller,
    ...
    return toDto(
        ReplicationController.class,
        client.update(toOpenshiftResource(client, replicationController)));
  }
}
