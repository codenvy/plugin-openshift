...
public final class OpenshiftProjectTypeConstants {
  ...
  /**
   * Openshift namespace variable used to know in which namespace associated (with current project)
   * openshift objects are stored
   */
  public static final String OPENSHIFT_NAMESPACE_VARIABLE_NAME = "openshift.namespace";

  /**
   * Openshift application variable used to know which value of label named 'application' is used by
   * openshift objects
   */
