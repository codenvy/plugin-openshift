...
@Path("/openshift/namespace/{namespace}/template")
public class TemplateService {
  ...
  public Template createTemplate(@PathParam("namespace") String namespace, Template template)
    ...
    if (!ResourceKind.TEMPLATE.equals(template.getKind())) {
      throw new BadRequestException(
          template.getKind() + " cannot be handled as a " + ResourceKind.TEMPLATE);
    }
  ...
  public List<Template> getTemplates(
    ...
    List<ITemplate> templates =
        clientFactory.getOpenshiftClient().list(ResourceKind.TEMPLATE, namespace, labels);
  ...
  public Template getTemplate(
      @PathParam("namespace") String namespace, @PathParam("template") String template)
      throws UnauthorizedException, ServerException {

    return toDto(
        Template.class,
        clientFactory.getOpenshiftClient().get(ResourceKind.TEMPLATE, template, namespace));
  }
